...
//     ioctl_write_nbytes(fid,addr,command,value,sizeof(oled_reg_init));
// }
...
// ********************************************************************************/
// void ioctl_OLED_SetGramScanWay(OLED_SCAN_DIR Scan_dir)
// {
...
function:
            initialization
********************************************************************************/
void ioctl_OLED_Init(OLED_SCAN_DIR OLED_ScanDir)
{
    //Hardware reset
    //OLED_Reset();
